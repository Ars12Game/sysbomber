...
try:
    ...
    print('CritErr:401. Убедитесь, что Python > 3.0 верно установлен.')
    sys.exit(1)
try:
    import requests
except ImportError:
    print('CritErr:402! Не удалось импортировать необходимые библиотеки.')
    print('Write "pip install requests" for solve this problem.')
    sys.exit(1)
...
def Logo():
    ...
    print('Warn! Некоторые сервисы научились предотвращать их использование.')
